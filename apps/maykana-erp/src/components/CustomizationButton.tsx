  ...
  return (
    <>
      ...
      <button
        ...
        } z-30 w-6 h-6 bg-gradient-to-br from-[#0A3B3D] to-[#104633] hover:from-[#104633] hover:to-[#1a5c4e] text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center group`}
        title="تخصيص المظهر"
      >
