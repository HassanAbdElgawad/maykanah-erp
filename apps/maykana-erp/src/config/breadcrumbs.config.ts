export const breadcrumbRoutes = [
  ...
  { path: "/warehouses/products-list", label: "warehouses.products_list" },
  { path: "/warehouses/products-list/add", label: "warehouses.add_product" },
  { path: "/warehouses/products-list/edit/:id", label: "warehouses.edit_product" },
  { path: "/warehouses/products-list/:id", label: "warehouses.view_product" },
  { path: "/warehouses/inventory-movements", label: "warehouses.inventory_movements" },
  { path: "/warehouses/inventory-movements/add", label: "warehouses.add_inventory_movement" },
  { path: "/warehouses/inventory-movements/edit/:id", label: "warehouses.edit_inventory_movement" },
  { path: "/warehouses/inventory-movements/:id", label: "warehouses.view_inventory_movement" },
  { path: "/warehouses/warehouse-movement", label: "warehouses.warehouse_movement" },
  { path: "/warehouses/warehouse-movement/select-type", label: "warehouses.select_movement_type" },
  { path: "/warehouses/warehouse-movement/transfer/add", label: "warehouses.transfer_stock" },
  { path: "/warehouses/warehouse-movement/transfer/edit/:id", label: "warehouses.edit_transfer_stock" },
  { path: "/warehouses/warehouse-movement/damage/add", label: "warehouses.damage_stock" },
  { path: "/warehouses/warehouse-movement/damage/edit/:id", label: "warehouses.edit_damage_stock" },
  { path: "/warehouses/inventory-closing", label: "warehouses.inventory_closing" },
  { path: "/warehouses/inventory-closing/add", label: "warehouses.add_inventory_closing" },
  { path: "/warehouses/inventory-closing/edit/:id", label: "warehouses.edit_inventory_closing" },
  { path: "/warehouses/material-requests", label: "warehouses.material_requests" },
  { path: "/warehouses/material-requests/damage/add", label: "warehouses.damage_stock" },
  { path: "/warehouses/material-requests/transfer/add", label: "warehouses.transfer_stock" },
  { path: "/warehouses/material-requests/damage/edit/:id", label: "warehouses.edit_damage_stock" },
  { path: "/warehouses/material-requests/transfer/edit/:id", label: "warehouses.edit_transfer_stock" },
  ...
  { path: "/warehouses/inventory-categories", label: "warehouses.inventory_categories" },
  { path: "/warehouses/inventory-categories/create", label: "warehouses.add_inventory_category" },
  { path: "/warehouses/inventory-categories/edit/:id", label: "warehouses.edit_inventory_category" },
  ...
  { path: "/warehouses/opening-balances/create", label: "warehouses.add_opening_balance" },
  { path: "/warehouses/opening-balances/edit/:id", label: "warehouses.edit_opening_balance" },
  { path: "/warehouses/price-lists", label: "warehouses.price_lists" },
  { path: "/warehouses/price-lists/create", label: "warehouses.add_price_list" },
  { path: "/warehouses/price-lists/edit/:id", label: "warehouses.edit_price_list" },
  { path: "/warehouses/batches", label: "warehouses.batches" },
  { path: "/warehouses/batches/create", label: "warehouses.add_batch" },
  { path: "/warehouses/batches/edit/:id", label: "warehouses.edit_batch" },
  { path: "/warehouses/item-price", label: "warehouses.item_price" },
  { path: "/warehouses/item-price/create", label: "warehouses.add_item_price" },
  { path: "/warehouses/item-price/edit/:id", label: "warehouses.edit_item_price" },
  { path: "/warehouses/serial-number", label: "warehouses.serial_number" },
  { path: "/warehouses/serial-number/create", label: "warehouses.add_serial_number" },
  { path: "/warehouses/serial-number/edit/:id", label: "warehouses.edit_serial_number" },
  { path: "/warehouses/goods-arrival-cost", label: "warehouses.goods_arrival_cost" },
  { path: "/warehouses/goods-arrival-cost/create", label: "warehouses.add_goods_arrival_cost" },
  { path: "/warehouses/goods-arrival-cost/edit/:id", label: "warehouses.edit_goods_arrival_cost" },
  ...
  { path: "/reports/warehouses", label: "sidebar.warehouses" },
  { path: "/reports/warehouses/inventory-status", label: "reports.warehouses.inventory_status" },
  { path: "/reports/warehouses/stock-movement", label: "reports.warehouses.stock_movement" },
  { path: "/reports/warehouses/warehouse-balances", label: "reports.warehouses.warehouse_balances" },
  { path: "/reports/warehouses/inventory-valuation", label: "reports.warehouses.inventory_valuation" },
