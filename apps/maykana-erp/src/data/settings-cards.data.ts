...
export const getSettingCards = (): SettingCard[] => [
  ...
  {
    id: 'maintenance-team',
    titleKey: 'settings.assets.maintenance_team',
    descriptionKey: 'settings.assets.maintenance_team_desc',
    icon: UsersIcon,
  ...
  // Warehouses Settings
  {
    id: 'general-warehouses-settings',
    titleKey: 'settings.warehouses.general_settings',
    descriptionKey: 'settings.warehouses.general_settings_desc',
    icon: SettingsIcon,
