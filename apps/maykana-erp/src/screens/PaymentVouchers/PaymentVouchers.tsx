...
import { getPaymentVouchersSampleData } from '../../data';

export const PaymentVouchers = (): JSX.Element => {
  ...
  const vouchers = getPaymentVouchersSampleData();
    ...
    <Layout>
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-end gap-3">
          ...
          {/* New Payment Button */}
          <button
            onClick={() => navigate('/accounting/payment-vouchers/create')}
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {vouchers.map((voucher) => (
                  <tr key={voucher.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                      {voucher.paymentMethodReceive}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                      {voucher.paymentMethodPay}
                    </td>
