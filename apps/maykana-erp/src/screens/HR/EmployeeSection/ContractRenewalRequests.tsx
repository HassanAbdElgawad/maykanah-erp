...
export const ContractRenewalRequests: React.FC = () => {
  ...
  // Mock data for contract renewal requests
  const contractRenewalRequests = [
    {
      ...
      requestedRenewalPeriod: 'سنة واحدة',
      status: 'pending',
    },
    {
      id: 2,
      ...
      currentEndDate: '2024-08-15',
      requestedRenewalPeriod: 'سنتان',
      status: 'approved',
    },
    {
      id: 3,
    ...
    },
    {
      ...
      department: 'التسويق',
      currentEndDate: '2024-09-10',
      requestedRenewalPeriod: 'ثلاث سنوات',
      status: 'pending',
    },
    {
      id: 5,
  ...
  const columns = [
    ...
    {
      key: 'currentEndDate',
      label: t('hr.current_end_date'),
      sortable: true,
      align: 'right' as const,
    },
    {
      key: 'requestedRenewalPeriod',
      label: t('hr.requested_renewal_period'),
      sortable: true,
      align: 'right' as const,
    },
    {
      ...
      <div  style={{ fontFamily: 'IBM Plex Sans Arabic, sans-serif' }}>
        ...
        <div className="flex items-center justify-between mb-6 bg-white p-4 rounded-xl border border-[#e2e2e2]">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-medium text-gray-900">{t('hr.contract_renewal_requests')}</h1>
          </div>

          <button
            onClick={() => navigate('/hr/employee/contract-renewal/new')}
            className={buttonClasses.primary}
          >
            {t('hr.new_contract_renewal_request')}
          </button>
        </div>
