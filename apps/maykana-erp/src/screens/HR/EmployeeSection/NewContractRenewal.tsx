...
export const NewContractRenewal: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Contract Renewal Request:', formData);
    navigate(getBackToList());
  };

  const renewalPeriodOptions = [
    { value: 'one_year', label: 'سنة واحدة' },
    { value: 'two_years', label: 'سنتان' },
    { value: 'three_years', label: 'ثلاث سنوات' },
    { value: 'four_years', label: 'أربع سنوات' },
    { value: 'five_years', label: 'خمس سنوات' },
  ];
      ...
      <div style={{ fontFamily: 'IBM Plex Sans Arabic, sans-serif' }}>
        ...
        <div className="flex items-center justify-between mb-6 bg-white p-4 rounded-xl border border-[#e2e2e2]">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-medium text-gray-900">{t('hr.contract_renewal')}</h1>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-base text-gray-600 text-right">
                    {t('hr.current_start_date')}
                  </label>
                  <input
                    type="date"
                    value={formData.currentStartDate}
                    onChange={(e) => setFormData({ ...formData, currentStartDate: e.target.value })}
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <select
                    ...
                    required
                  >
                    <option value="">{t('hr.select_renewal_period')}</option>
