...
export function Agreements() {
  ...
  const handleEdit = (id: number) => {
    navigate(`/competitions/agreements/edit/${id}`);
  };
      ...
      >
        ...
        <div className="flex items-center justify-between bg-white p-4 rounded-xl border border-[#e2e2e2]">
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={() => navigate('/competitions/agreements/add')}
              className={buttonClasses.primary}
            >
              {t('competitions.agreements.add_new')}
            </button>
          </div>
        </div>
        ...
        {showFilters && (
          <div className="bg-white p-6 rounded-xl border border-[#e2e2e2] animate-fade-in">
            <div className="grid grid-cols-4 gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                <Label className="text-sm font-medium text-gray-700">
                  {t('competitions.agreements.supplier_type')}
                </Label>
                <Input
                  type="text"
                  placeholder={t('competitions.agreements.supplier_type')}
              ...
              <div className="flex flex-col gap-1.5">
                <Label className="text-sm font-medium text-gray-700">
                  {t('competitions.agreements.project')}
                </Label>
                <Input
                  type="text"
                  placeholder={t('competitions.agreements.project')}
        ...
        <div className="bg-white rounded-xl border border-[#e2e2e2] overflow-hidden">
          <AdvancedTable
            ...
            columns={[
              {
                key: 'supplier',
                label: t('competitions.agreements.supplier'),
              },
              {
                key: 'agreementNumber',
                label: t('competitions.agreements.agreement_number'),
              },
              {
                key: 'supplierType',
                label: t('competitions.agreements.supplier_type'),
              },
              {
                key: 'project',
                label: t('competitions.agreements.project'),
              },
              {
                key: 'confirmationDate',
                label: t('competitions.agreements.confirmation_date'),
              },
              {
                key: 'competitionNumber',
                label: t('competitions.agreements.competition_number'),
              },
            ]}
