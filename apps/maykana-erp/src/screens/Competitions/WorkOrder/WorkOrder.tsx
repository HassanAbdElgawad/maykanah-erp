...
export function WorkOrder() {
  ...
  const mockData = [
    {
      id: 1,
      agreement: 'أحمد عبد السلام',
      workOrderNumber: '15123222121',
  ...
  const handleEdit = (id: number) => {
    navigate(`/competitions/work-order/edit/${id}`);
  };
      ...
      >
        ...
        <div className="flex items-center justify-between bg-white p-4 rounded-xl border border-[#e2e2e2]">
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={() => navigate('/competitions/work-order/add')}
              className={buttonClasses.primary}
            >
              {t('competitions.work_order.add_new')}
            </button>
          </div>
        </div>
            ...
            <div className="grid grid-cols-4 gap-4">
              <div className="flex flex-col gap-1.5">
                ...
                <Input
                  ...
                  onChange={(e) => handleFilterChange('agreement', e.target.value)}
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <Input
                  ...
                  onChange={(e) => handleFilterChange('workOrderNumber', e.target.value)}
                  className="w-full h-[42px] px-3 border border-[#e2e2e2] rounded-lg bg-white"
                />
              </div>
              <div className="flex flex-col gap-1.5">
                <Label className="text-sm font-medium text-gray-700">
                  {t('competitions.work_order.supplier_type')}
                </Label>
                <Input
                  type="text"
                  placeholder={t('competitions.work_order.supplier_type')}
        ...
        <div className="bg-white rounded-xl border border-[#e2e2e2] overflow-hidden">
          <AdvancedTable
            ...
            columns={[
              {
                key: 'agreement',
                label: t('competitions.work_order.agreement'),
              },
              {
                key: 'workOrderNumber',
                label: t('competitions.work_order.work_order_number'),
              },
              {
                key: 'supplierType',
                label: t('competitions.work_order.supplier_type'),
              },
              {
                key: 'project',
                label: t('competitions.work_order.project'),
              },
              {
                key: 'confirmationDate',
                label: t('competitions.work_order.confirmation_date'),
              },
              {
                key: 'competitionNumber',
                label: t('competitions.work_order.competition_number'),
              },
            ]}
