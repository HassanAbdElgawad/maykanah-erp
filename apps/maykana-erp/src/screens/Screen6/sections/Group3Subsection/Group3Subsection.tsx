  ...
  return (
    <div className="relative w-full h-full">
      <div className="flex flex-col">
        <div className="flex items-center justify-end h-[55px] px-4">
        ...
        {employees.map((employee, index) => (
          <div
            key={index}
            className="flex items-center justify-end h-[55px] px-4"
          >
            <div className="[font-family:'IBM_Plex_Sans_Arabic',Helvetica] font-normal text-[#0e0d24] text-base tracking-[0] leading-normal [direction:rtl]">
              {employee.name}
            </div>
          </div>
        ))}
