            ...
            <div className="px-6 pb-6 space-y-4 border-t border-[#e2e2e2]">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-4">
                ...
                <div>
                  ...
                  <select
                    defaultValue={category.depreciationMethod}
                    className="w-full h-[45px] px-3 bg-white border border-[#cfcfcf] rounded-lg text-sm [font-family:'IBM_Plex_Sans_Arabic',Helvetica]"
                    dir="rtl"
                  >
                ...
                <div>
                  ...
                  <select
                    defaultValue={category.usefulLife}
                    className="w-full h-[45px] px-3 bg-white border border-[#cfcfcf] rounded-lg text-sm [font-family:'IBM_Plex_Sans_Arabic',Helvetica]"
                    dir="rtl"
                  >
                ...
                <div>
                  ...
                  <input
                    type="text"
                    defaultValue={category.residualValue}
                    placeholder="10%"
                    className="w-full h-[45px] px-3 bg-white border border-[#cfcfcf] rounded-lg text-sm [font-family:'IBM_Plex_Sans_Arabic',Helvetica]"
                    dir="rtl"
                  />
                ...
                <div>
                  ...
                  <select
                    defaultValue={category.assetAccount}
                    className="w-full h-[45px] px-3 bg-white border border-[#cfcfcf] rounded-lg text-sm [font-family:'IBM_Plex_Sans_Arabic',Helvetica]"
                    dir="rtl"
                  >
            ...
            <div className="px-6 pb-6 space-y-4 border-t border-[#e2e2e2]">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-4">
                ...
                <div>
                  ...
                  <select
                    defaultValue={category.accumulatedDepreciationAccount}
                    className="w-full h-[45px] px-3 bg-white border border-[#cfcfcf] rounded-lg text-sm [font-family:'IBM_Plex_Sans_Arabic',Helvetica]"
                    dir="rtl"
                  >
                    <option value="">اختر حساب</option>
                ...
                <div>
                  ...
                  <select
                    defaultValue={category.depreciationExpenseAccount}
                    className="w-full h-[45px] px-3 bg-white border border-[#cfcfcf] rounded-lg text-sm [font-family:'IBM_Plex_Sans_Arabic',Helvetica]"
                    dir="rtl"
                  >
                    <option value="">اختر حساب</option>
            ...
            <div className="px-6 pb-6 space-y-4 border-t border-[#e2e2e2]">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-4">
                ...
                <div>
                  ...
                  <select
                    defaultValue={category.depreciationPeriods}
                    className="w-full h-[45px] px-3 bg-white border border-[#cfcfcf] rounded-lg text-sm [font-family:'IBM_Plex_Sans_Arabic',Helvetica]"
                    dir="rtl"
                  >
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    type="number"
                    defaultValue={category.depreciationRate}
                    className="w-full h-[45px] px-3 bg-white border border-[#cfcfcf] rounded-lg text-sm [font-family:'IBM_Plex_Sans_Arabic',Helvetica]"
                    dir="rtl"
                  />
