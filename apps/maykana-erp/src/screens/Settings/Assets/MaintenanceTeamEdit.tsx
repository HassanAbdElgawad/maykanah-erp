...
export const MaintenanceTeamEdit = (): JSX.Element => {
  ...
  const handleAddOrUpdateMember = () => {
    if (editingMember) {
      ...
      setMembers(
        members.map((m) => (m.id === editingMember.id ? { ...editingMember, ...memberForm } : m))
      );
    } else {
      // Add new member
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="space-y-2">
                            <div
                              className="flex items-center gap-2 text-sm text-gray-600 [font-family:'IBM_Plex_Sans_Arabic',Helvetica]"
                              dir="ltr"
                            >
                              <button
                  ...
                  <div className="space-y-2">
                    ...
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        onChange={(e) =>
                          setMemberForm({ ...memberForm, isLeader: e.target.checked })
                        }
