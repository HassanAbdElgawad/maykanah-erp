...
import { getWarehousesSampleData, type Warehouse } from '@/data/settings/warehouse-management.data';
...
export const WarehouseManagement = () => {
  ...
  const [warehouses, setWarehouses] = useState<Warehouse[]>(() => getWarehousesSampleData());
