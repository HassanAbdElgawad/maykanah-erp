...
export const BudgetEditForm = (): JSX.Element => {
  ...
  const [budgetName, setBudgetName] = useState('موازنة إيطاليا');

  // Calculate total budget
  const totalBudget = budgetAccounts.reduce((sum, account) => sum + account.amount, 0);

  useEffect(() => {
    // TODO: Load budget data based on id
    ...
    <Layout>
      <div className="space-y-4">
        ...
        <Card className="bg-white rounded-xl border border-[#e2e2e2] p-8">
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-6 font-semibold text-sm text-[#093738] [font-family:'IBM_Plex_Sans_Arabic',Helvetica] pb-2 border-b border-gray-200">
              <div>الحساب</div>
              <div className="text-center">قيمة الموازنة</div>
            </div>

            {budgetAccounts.map((account) => (
              <div key={account.id} className="grid grid-cols-2 gap-6 items-center">
                <span className="text-sm text-[#093738] [font-family:'IBM_Plex_Sans_Arabic',Helvetica]">
                  {account.name}
                </span>
                <div className="relative">
                  <input
                    ...
                    onChange={(e) => handleAmountChange(account.id, Number(e.target.value))}
            ...
            <div className="pt-4 border-t-2 border-gray-300">
              <div className="grid grid-cols-2 gap-6 items-center">
                <span className="text-base font-bold text-[#093738] [font-family:'IBM_Plex_Sans_Arabic',Helvetica]">
                ...
                <div className="text-center">
                  <div className="inline-flex items-center gap-2 text-lg font-bold text-[#093738] [font-family:'IBM_Plex_Sans_Arabic',Helvetica]">
                    <img src="/images/currency/saudi-riyal.svg" alt="ريال" className="w-4 h-4" />
