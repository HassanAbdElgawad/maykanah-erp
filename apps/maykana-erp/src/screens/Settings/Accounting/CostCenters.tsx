...
import { getCostCentersSampleData, type CostCenter } from '@/data/settings/cost-centers.data';
...
export const CostCenters = (): JSX.Element => {
  ...
  const [costCenters, setCostCenters] = useState<CostCenter[]>(() => getCostCentersSampleData());
