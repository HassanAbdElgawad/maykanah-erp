...
export const AddEditInventoryMovement = (): JSX.Element => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    navigate('/warehouses/inventory-movements');
  };
          ...
          <div className="p-4 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-xl font-medium text-black [font-family:'IBM_Plex_Sans_Arabic',Helvetica]">
                {isEditMode
                  ? t('warehouses.edit_inventory_movement')
            ...
            <div className="space-y-2">
              ...
              >
                <SelectTrigger className="h-[45px] bg-slate-50">
                  <SelectValue placeholder={t('warehouses.select_movement_type')} />
                </SelectTrigger>
                <SelectContent>
