  ...
  return (
    <Layout>
      <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="p-4 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-xl font-medium text-black [font-family:'IBM_Plex_Sans_Arabic',Helvetica]">
                {isEditMode
                  ? t('warehouses.edit_transfer_stock')
        ...
        {/* Transfer Stock Information */}
        <CollapsibleSection title={t('warehouses.transfer_stock_info')} defaultOpen={true}>
          <div className="grid grid-cols-4 gap-4">
            ...
            <div className="space-y-2 col-span-2">
              <label className="text-sm font-medium text-gray-700 [font-family:'IBM_Plex_Sans_Arabic',Helvetica]">
                {t('warehouses.target_warehouse')}
              </label>
              <Select
                value={formData.targetWarehouse}
                onValueChange={(value) => handleInputChange('targetWarehouse', value)}
              >
                <SelectTrigger className="h-[45px] bg-slate-50">
                  <SelectValue placeholder={t('warehouses.select_target_warehouse')} />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="warehouse1">
                    {t('warehouses.riyadh_warehouse')}
